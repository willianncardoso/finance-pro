...
export interface Txn { id?: string; d: string; merch: string; cat: string; acct: string; amt: number; sub?: string; recurring?: boolean; exclude?: boolean; reimbursable?: boolean; notes?: string; installment?: string | null; }
