...
export interface Txn { id?: string; d: string; merch: string; cat: string; acct: string; amt: number; sub?: string; recurring?: boolean; exclude?: boolean; excludeReimb?: boolean; reimbursable?: boolean; reimburseReceived?: boolean; reimbAmt?: number; notes?: string; installment?: string | null; kind?: 'card' | 'account'; source?: 'paste' | 'ocr'; }
